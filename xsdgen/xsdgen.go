package xsdgen // import "github.com/Deutsche-Boerse/go-xml/xsdgen"
...
import (
	...
	"github.com/Deutsche-Boerse/go-xml/internal/dependency"
	"github.com/Deutsche-Boerse/go-xml/internal/gen"
	"github.com/Deutsche-Boerse/go-xml/xmltree"
...
func toJsonName(value string) string {
	...
	return strings.ToLower(string(value[0])) + string(value[1:])
}
